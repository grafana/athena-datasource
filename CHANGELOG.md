...
- Chore: Move docs to docs/sources to enable publishing to website in [#692](https://github.com/grafana/athena-datasource/pull/692)
- CD: Publish Github release directly, skipping draft step in [#690](https://github.com/grafana/athena-datasource/pull/690)
- Update workflows and templates in [#657](https://github.com/grafana/athena-datasource/pull/657)
- Update dependabot groups in [#681](https://github.com/grafana/athena-datasource/pull/681)
- Fix dependabot ignore location for npm dependencies in [#650](https://github.com/grafana/athena-datasource/pull/650)
- Tweak dependabot schedule in [#649](https://github.com/grafana/athena-datasource/pull/649)
- Dependencies: Update aws-sdk-go-v2 and service/athena in [#644](https://github.com/grafana/athena-datasource/pull/644)
- Remove pr_commands in [#597](https://github.com/grafana/athena-datasource/pull/597)
- Chore: Use CI/CD actions for e2e in [#639](https://github.com/grafana/athena-datasource/pull/639)
- revert eslint-config-prettier to 10.1.5 in [#632](https://github.com/grafana/athena-datasource/pull/632)
- Remove @types/glob in [#627](https://github.com/grafana/athena-datasource/pull/627)
- update github.com/grafana/grafana-aws-sdk to v1.0.2 in [#586](https://github.com/grafana/athena-datasource/pull/586)
- Add support for auto-merging dependabot updates in [#561](https://github.com/grafana/athena-datasource/pull/561)
- Chore: Update CONTRIBUTING.md with release instructions in [#560](https://github.com/grafana/athena-datasource/pull/560)
- Chore: Migrate to Github actions in [#545](https://github.com/grafana/athena-datasource/pull/545)
- Dependabot updates:
  - Bump @types/node from 22.18.10 to 22.18.11 in the npm-patch-dev-dependencies group across 1 directory [#739](https://github.com/grafana/athena-datasource/pull/739)
  - Bump the aws-sdk-go-v2 group with 2 updates in [#734](https://github.com/grafana/athena-datasource/pull/734)
  - Bump github.com/grafana/grafana-aws-sdk from 1.3.0 to 1.3.1 in [#735](https://github.com/grafana/athena-datasource/pull/735)
  - Bump @grafana/plugin-ui from 0.10.10 to 0.11.1 in [#732](https://github.com/grafana/athena-datasource/pull/732)
  - Bump @grafana/tsconfig from 2.0.0 to 2.0.1 in the npm-patch-dev-dependencies group in [#724](https://github.com/grafana/athena-datasource/pull/724)
  - Bump github.com/grafana/grafana-plugin-sdk-go from 0.280.0 to 0.281.0 in [#723](https://github.com/grafana/athena-datasource/pull/723)
  - Bump @typescript-eslint/parser from 8.44.1 to 8.46.0 in [#720](https://github.com/grafana/athena-datasource/pull/720)
  - Bump @types/node from 22.18.9 to 22.18.10 in the npm-patch-dev-dependencies group in [#717](https://github.com/grafana/athena-datasource/pull/717)
  - Bump @types/node from 22.18.8 to 22.18.9 in the npm-patch-dev-dependencies group in [#715](https://github.com/grafana/athena-datasource/pull/715)
  - Bump jest-environment-jsdom from 30.0.5 to 30.2.0 in [#713](https://github.com/grafana/athena-datasource/pull/713)
  - Bump webpack from 5.101.3 to 5.102.0 in [#709](https://github.com/grafana/athena-datasource/pull/709)
  - Bump @types/node from 22.16.5 to 22.18.7 in [#708](https://github.com/grafana/athena-datasource/pull/708)
  - Bump typescript from 5.9.2 to 5.9.3 in the npm-patch-dev-dependencies group in [#707](https://github.com/grafana/athena-datasource/pull/707)
  - Bump typescript from 5.8.3 to 5.9.2 in [#704](https://github.com/grafana/athena-datasource/pull/704)
  - Bump jest from 30.0.5 to 30.2.0 in [#706](https://github.com/grafana/athena-datasource/pull/706)
  - Bump @typescript-eslint/eslint-plugin from 8.37.0 to 8.44.1 in [#705](https://github.com/grafana/athena-datasource/pull/705)
  - Bump @playwright/test from 1.54.1 to 1.55.1 in [#702](https://github.com/grafana/athena-datasource/pull/702)
  - Bump sass from 1.89.2 to 1.93.2 in [#703](https://github.com/grafana/athena-datasource/pull/703)
  - Bump eslint from 9.31.0 to 9.36.0 in [#700](https://github.com/grafana/athena-datasource/pull/700)
  - Bump lefthook from 1.13.5 to 1.13.6 in the npm-patch-dev-dependencies group in [#699](https://github.com/grafana/athena-datasource/pull/699)
  - Bump @grafana/eslint-config from 8.1.0 to 8.2.0 in [#698](https://github.com/grafana/athena-datasource/pull/698)
  - Bump lefthook from 1.13.4 to 1.13.5 in the npm-patch-dev-dependencies group in [#697](https://github.com/grafana/athena-datasource/pull/697)
  - Bump the aws-sdk-go-v2 group with 2 updates in [#696](https://github.com/grafana/athena-datasource/pull/696)
  - Bump @grafana/plugin-ui from 0.10.7 to 0.10.10 in [#665](https://github.com/grafana/athena-datasource/pull/665)
  - Bump actions/checkout from 4 to 5 in [#660](https://github.com/grafana/athena-datasource/pull/660)
  - Bump github.com/grafana/grafana-aws-sdk from 1.1.0 to 1.3.0 in [#693](https://github.com/grafana/athena-datasource/pull/693)
  - Bump the npm-patch-dev-dependencies group across 1 directory with 2 updates in [#694](https://github.com/grafana/athena-datasource/pull/694)
  - Bump webpack from 5.100.2 to 5.101.3 in [#688](https://github.com/grafana/athena-datasource/pull/688)
  - Bump @typescript-eslint/parser from 8.37.0 to 8.43.0 in [#687](https://github.com/grafana/athena-datasource/pull/687)
  - Bump cspell from 9.1.5 to 9.2.1 in [#686](https://github.com/grafana/athena-datasource/pull/686)
  - Bump the npm-patch-dev-dependencies group with 7 updates in [#685](https://github.com/grafana/athena-datasource/pull/685)
  - Bump actions/setup-node from 4 to 5 in [#674](https://github.com/grafana/athena-datasource/pull/674)
  - Bump actions/stale from 9 to 10 in [#675](https://github.com/grafana/athena-datasource/pull/675)
  - Bump github.com/aws/aws-sdk-go-v2/service/athena from 1.55.2 to 1.55.4 in [#682](https://github.com/grafana/athena-datasource/pull/682)
  - Bump github.com/aws/aws-sdk-go-v2/service/athena from 1.52.0 to 1.55.2 in [#677](https://github.com/grafana/athena-datasource/pull/677)
  - Bump jest-environment-jsdom from 30.0.4 to 30.0.5 in [#646](https://github.com/grafana/athena-datasource/pull/646)
  - Bump github.com/grafana/grafana-aws-sdk from 1.0.6 to 1.1.0 in [#651](https://github.com/grafana/athena-datasource/pull/651)
  - Bump jest from 30.0.4 to 30.0.5 in [#647](https://github.com/grafana/athena-datasource/pull/647)
  - Bump github.com/grafana/grafana-aws-sdk from 1.0.5 to 1.0.6 in [#642](https://github.com/grafana/athena-datasource/pull/642)
  - Bump github.com/aws/aws-sdk-go-v2 from 1.36.5 to 1.36.6 in [#641](https://github.com/grafana/athena-datasource/pull/641)
  - Bump github.com/grafana/sqlds/v4 from 4.2.4 to 4.2.6 in [#640](https://github.com/grafana/athena-datasource/pull/640)
  - Bump @grafana/plugin-e2e from 2.1.6 to 2.1.7 in [#637](https://github.com/grafana/athena-datasource/pull/637)
  - Bump eslint-config-prettier from 10.1.5 to 10.1.8 in [#636](https://github.com/grafana/athena-datasource/pull/636)
  - Bump eslint-plugin-prettier from 5.5.1 to 5.5.3 in [#635](https://github.com/grafana/athena-datasource/pull/635)
  - Bump @types/node from 22.16.4 to 22.16.5 in [#634](https://github.com/grafana/athena-datasource/pull/634)
  - Bump @swc/core from 1.13.0 to 1.13.1 in [#633](https://github.com/grafana/athena-datasource/pull/633)
  - Bump eslint-config-prettier from 10.1.5 to 10.1.7 in [#630](https://github.com/grafana/athena-datasource/pull/630)
  - Bump @swc/core from 1.12.14 to 1.13.0 in [#631](https://github.com/grafana/athena-datasource/pull/631)
  - Bump @swc/jest from 0.2.38 to 0.2.39 in [#625](https://github.com/grafana/athena-datasource/pull/625)
  - Bump @typescript-eslint/eslint-plugin from 8.35.1 to 8.37.0 in [#629](https://github.com/grafana/athena-datasource/pull/629)
  - Bump @grafana/plugin-e2e from 2.1.5 to 2.1.6 in [#626](https://github.com/grafana/athena-datasource/pull/626)
  - Bump @swc/core from 1.12.11 to 1.12.14 in [#628](https://github.com/grafana/athena-datasource/pull/628)
  - Bump @playwright/test from 1.53.2 to 1.54.1 in [#621](https://github.com/grafana/athena-datasource/pull/621)
  - Bump lefthook from 1.11.16 to 1.12.2 in [#624](https://github.com/grafana/athena-datasource/pull/624)
  - Bump @typescript-eslint/parser from 8.35.1 to 8.37.0 in [#623](https://github.com/grafana/athena-datasource/pull/623)
  - Bump webpack from 5.99.9 to 5.100.2 in [#622](https://github.com/grafana/athena-datasource/pull/622)
  - Bump eslint-plugin-jsdoc from 50.8.0 to 51.4.1 in [#620](https://github.com/grafana/athena-datasource/pull/620)
  - Bump eslint from 9.30.1 to 9.31.0 in [#618](https://github.com/grafana/athena-datasource/pull/618)
  - Bump @babel/core from 7.27.7 to 7.28.0 in [#619](https://github.com/grafana/athena-datasource/pull/619)
  - Bump cspell from 9.1.3 to 9.1.5 in [#617](https://github.com/grafana/athena-datasource/pull/617)
  - Bump @types/node from 22.15.35 to 22.16.4 in [#616](https://github.com/grafana/athena-datasource/pull/616)
  - Bump github.com/grafana/sqlds/v4 from 4.2.3 to 4.2.4 in [#615](https://github.com/grafana/athena-datasource/pull/615)
  - Bump @grafana/plugin-e2e from 2.1.3 to 2.1.5 in [#612](https://github.com/grafana/athena-datasource/pull/612)
  - Bump @swc/core from 1.12.9 to 1.12.11 in [#614](https://github.com/grafana/athena-datasource/pull/614)
  - Bump eslint from 9.30.0 to 9.30.1 in [#613](https://github.com/grafana/athena-datasource/pull/613)
  - Bump cspell from 9.1.2 to 9.1.3 in [#609](https://github.com/grafana/athena-datasource/pull/609)
  - Bump eslint from 9.29.0 to 9.30.0 in [#610](https://github.com/grafana/athena-datasource/pull/610)
  - Bump github.com/grafana/grafana-aws-sdk from 1.0.3 to 1.0.5 in [#607](https://github.com/grafana/athena-datasource/pull/607)
  - Bump lefthook from 1.11.14 to 1.11.16 in [#604](https://github.com/grafana/athena-datasource/pull/604)
  - Bump @typescript-eslint/eslint-plugin from 8.35.0 to 8.35.1 in [#606](https://github.com/grafana/athena-datasource/pull/606)
  - Bump jest from 30.0.3 to 30.0.4 in [#605](https://github.com/grafana/athena-datasource/pull/605)
  - Bump jest-environment-jsdom from 30.0.2 to 30.0.4 in [#603](https://github.com/grafana/athena-datasource/pull/603)
  - Bump github.com/grafana/grafana-aws-sdk from 1.0.2 to 1.0.3 in [#602](https://github.com/grafana/athena-datasource/pull/602)
  - Bump github.com/aws/aws-sdk-go-v2/service/athena from 1.51.2 to 1.51.3 in [#596](https://github.com/grafana/athena-datasource/pull/596)
  - Bump @typescript-eslint/parser from 8.35.0 to 8.35.1 in [#600](https://github.com/grafana/athena-datasource/pull/600)
  - Bump @types/lodash from 4.17.19 to 4.17.20 in [#601](https://github.com/grafana/athena-datasource/pull/601)
  - Bump @typescript-eslint/eslint-plugin from 8.34.1 to 8.35.0 in [#599](https://github.com/grafana/athena-datasource/pull/599)
  - Bump @types/node from 22.15.34 to 22.15.35 in [#598](https://github.com/grafana/athena-datasource/pull/598)
  - Bump @playwright/test from 1.53.1 to 1.53.2 in [#594](https://github.com/grafana/athena-datasource/pull/594)
  - Bump @typescript-eslint/parser from 8.34.1 to 8.35.0 in [#593](https://github.com/grafana/athena-datasource/pull/593)
  - Bump @swc/core from 1.12.7 to 1.12.9 in [#595](https://github.com/grafana/athena-datasource/pull/595)
  - Bump prettier from 3.6.0 to 3.6.2 in [#592](https://github.com/grafana/athena-datasource/pull/592)
  - Bump prettier from 3.5.3 to 3.6.0 in [#591](https://github.com/grafana/athena-datasource/pull/591)
  - Bump eslint-plugin-prettier from 5.5.0 to 5.5.1 in [#590](https://github.com/grafana/athena-datasource/pull/590)
  - Bump @typescript-eslint/eslint-plugin from 8.32.1 to 8.34.1 in [#589](https://github.com/grafana/athena-datasource/pull/589)
  - Bump @types/node from 22.15.33 to 22.15.34 in [#588](https://github.com/grafana/athena-datasource/pull/588)
  - Bump @grafana/plugin-e2e from 2.1.2 to 2.1.3 in [#587](https://github.com/grafana/athena-datasource/pull/587)
  - Bump @types/node from 22.15.32 to 22.15.33 in [#584](https://github.com/grafana/athena-datasource/pull/584)
  - Bump @playwright/test from 1.53.0 to 1.53.1 in [#581](https://github.com/grafana/athena-datasource/pull/581)
  - Bump @typescript-eslint/parser from 8.32.1 to 8.34.1 in [#585](https://github.com/grafana/athena-datasource/pull/585)
  - Bump @swc/core from 1.12.1 to 1.12.7 in [#583](https://github.com/grafana/athena-datasource/pull/583)
  - Bump eslint-plugin-prettier from 5.4.1 to 5.5.0 in [#582](https://github.com/grafana/athena-datasource/pull/582)
  - Bump cspell from 9.1.1 to 9.1.2 in [#580](https://github.com/grafana/athena-datasource/pull/580)
  - Bump eslint from 9.27.0 to 9.29.0 in [#579](https://github.com/grafana/athena-datasource/pull/579)
  - Bump @grafana/plugin-ui from 0.10.6 to 0.10.7 in [#577](https://github.com/grafana/athena-datasource/pull/577)
  - Bump @babel/core from 7.27.4 to 7.27.7 in [#578](https://github.com/grafana/athena-datasource/pull/578)
  - Bump eslint-plugin-jsdoc from 50.6.17 to 50.8.0 in [#576](https://github.com/grafana/athena-datasource/pull/576)
  - Bump @types/lodash from 4.17.17 to 4.17.18 in [#573](https://github.com/grafana/athena-datasource/pull/573)
  - Bump @grafana/plugin-e2e from 2.0.5 to 2.1.2 in [#574](https://github.com/grafana/athena-datasource/pull/574)
  - Bump jest-environment-jsdom from 30.0.0 to 30.0.2 in [#571](https://github.com/grafana/athena-datasource/pull/571)
  - Bump jest from 30.0.0 to 30.0.3 in [#568](https://github.com/grafana/athena-datasource/pull/568)
  - Bump the grafana-dependencies group with 4 updates in [#567](https://github.com/grafana/athena-datasource/pull/567)
  - Bump github.com/grafana/grafana-plugin-sdk-go from 0.277.1 to 0.278.0 in [#570](https://github.com/grafana/athena-datasource/pull/570)
  - Bump github.com/aws/aws-sdk-go-v2/service/athena from 1.51.1 to 1.51.2 in [#566](https://github.com/grafana/athena-datasource/pull/566)
  - Bump the all-go-dependencies group with 3 updates in [#559](https://github.com/grafana/athena-datasource/pull/559)
  - Bump the all-node-dependencies group with 12 updates in [#558](https://github.com/grafana/athena-datasource/pull/558)
