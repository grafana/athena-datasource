...
| `$__rawtimeFrom()`                   | `$__rawTimeFrom` outputs the current starting time of the range of the panel formatted as a string. An optional argument is used to specify the output format of the string using Presto's [Java Date Functions](https://prestodb.io/docs/current/functions/datetime.html#java-date-functions) `format_datetime(timestamp, format)` when a custom format is passed as an argument.                                                                                       | 1. Without specifying a format: `$__rawTimeFrom()` <br /><br />2. Using the [default format](https://github.com/grafana/athena-datasource/tree/v1.0.3/pkg/athena/macros.go#L14): `$__rawTimeFrom('yyyy-MM-dd HH:mm:ss')`<br /><br />3. With a custom format: `$__rawTimeFrom('yyyy/MM/dd/HH)`                                      | 1. Without specifying a format: `format_datetime(TIMESTAMP '2022-03-24 21:19:03','yyyy-MM-dd HH:mm:ss')`<br /><br />2. Using the [default format](https://github.com/grafana/athena-datasource/tree/v1.0.3/pkg/athena/macros.go#L14): `format_datetime(TIMESTAMP '2022-03-24 21:19:03','yyyy-MM-dd HH:mm:ss')`<br /><br />3. With another custom format: `format_datetime(TIMESTAMP '2022-03-24 21:19:03','yyyy/MM/dd/HH')`                                                                                                  |
...
| `$__rawTimeTo()`                     | `$__rawTimeTo` outputs the current ending time of the range of the panel formatted as a string. An optional argument is used to specify the output format of the string using Presto's [Java Date Functions](https://prestodb.io/docs/current/functions/datetime.html#java-date-functions) `format_datetime(timestamp, format)` when a custom format is passed as an argument.                                                                                           | 1. Without specifying a format: `$__rawTimeTo()` <br /><br />2. Using the [default format](https://github.com/grafana/athena-datasource/tree/v1.0.3/pkg/athena/macros.go#L14): `$__rawTimeTo('yyyy-MM-dd HH:mm:ss')`<br /><br />3. With a custom format: `$__rawTimeTo('yyyy/MM/dd/HH)`                                            | 1. Without specifying a format: `format_datetime(TIMESTAMP '2022-03-24 21:19:03','yyyy-MM-dd HH:mm:ss')`<br /><br />2. Using the [default format](https://github.com/grafana/athena-datasource/tree/v1.0.3/pkg/athena/macros.go#L14): `format_datetime(TIMESTAMP '2022-03-24 21:19:03','yyyy-MM-dd HH:mm:ss')`<br /><br />3. With another custom format: `format_datetime(TIMESTAMP '2022-03-24 21:19:03','yyyy/MM/dd/HH')`                                                                                                  |
