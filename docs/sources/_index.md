...
You can request new features, report issues, or contribute code directly through the [Athena data source plugin Github repository](https://github.com/grafana/athena-datasource/)