...
export const ResourceMacros = ({ query, datasource, onChange, onRunQuery, dependencies }: ResourceMacrosProps) => {
  ...
  const fetchTables = useCallback(
    () => datasource.postResource('tablesWithConnectionDetails', { ...query.connectionArgs }),
    [datasource, query]
  );
  ...
  const fetchColumns = useCallback(
    () => datasource.postResource('columnsWithConnectionDetails', { ...query.connectionArgs, table: query.table }),
    [datasource, query]
  );
